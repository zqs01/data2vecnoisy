...
@dataclass
class ModelCriterionConfigNoisy(FairseqDataclass):
...
@register_criterion("modelnoisy", dataclass=ModelCriterionConfigNoisy)
class ModelCriterionNoisy(FairseqCriterion):
    """
